...
const Attendance_Teacher = () => {
  const { fetchStudents, students, submitAttendance } = useGlobalContext();
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-start w-full p-4">
        <h3 className="text-2xl font-bold text-center text-white mb-8 mr-5">
          Class : <span className="underline">{}dwe</span>
        </h3>
